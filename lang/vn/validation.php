...
return [
    ...
    'doesnt_contain' => 'Trường :attribute không được chứa các giá trị: :values.',
    ...
    'in_array_keys' => 'Trường :attribute phải chứa ít nhất một key: :values.',
    ...
    'lte' => [
        'array' => 'Trường :attribute không được vượt quá :value phần tử.',
        'file' => 'Trường :attribute phải nhỏ hơn hoặc bằng :value kilobytes.',
        'numeric' => 'Trường :attribute phải nhỏ hơn hoặc bằng :value.',
        'string' => 'Trường :attribute phải không dài quá :value ký tự.',
    ],
    ...
    'max_digits' => 'Trường :attribute không được quá :max chữ số.',
    ...
    'password' => [
        ...
        'uncompromised' => ':attribute đã xuất hiện trong dữ liệu bị rò rỉ. Hãy chọn :attribute khác.',
    ],
    ...
    'present_with' => 'Trường :attribute phải tồn tại khi :values có mặt.',
    'present_with_all' => 'Trường :attribute phải tồn tại khi tất cả :values có mặt.',
    ...
    'prohibits' => 'Trường :attribute không cho phép :other tồn tại.',
    ...
    'required_without_all' => 'Trường :attribute là bắt buộc khi tất cả :values không tồn tại.',
